from data_utils import create_mask, get_existing_mask, see_img, get_existing_img, visualize_points, crop_image_according_to_mask, save_roof_img, save_wall_measurements
from processing import finding_closest_contour, generate_points_inside_contour, scale_contour, sam_predictor, mask_adjustment
from processing.proc_utils import calculate_wall_measurements

from config import data_creation, scale_factor

if data_creation: mask, image, mask_id = create_mask(data_img_id = 0)
else:
